import { Component, ElementRef, AfterViewInit, Input, Output, EventEmitter, TemplateRef, ViewChild } from '@angular/core';
...
export class DeviceTableComponent extends BaseTable implements AfterViewInit {
