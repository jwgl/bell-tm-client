...
@NgModule({
    ...
    providers: [
        ...
        { provide: 'ADMIN_CLASS_ATTENDANCE_API_URL', useValue: '/api/here/departments/${departmentId}/adminClasses' },
        { provide: 'ATTENDANCE_API_URL', useValue: '/api/here/attendances' },
        { provide: 'IS_ATTENDANCE_ADMIN', useValue: true },
    ],
})
export class DepartmentAdminClassAttendanceModule { }
