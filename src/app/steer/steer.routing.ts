...
const routes: Routes = [{
    ...
    loadChildren: () => import('./observation/settings/department/department-observer-setting.module')
        .then(m => m.DepartmentObserverSettingModule),
}, {
    path: 'obervers/:userId/deans',
    loadChildren: () => import('./observation/department/dean.module').then(m => m.DeanModule),
}];
